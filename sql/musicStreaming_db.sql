...
INSERT INTO `user` (`id`, `email`, `roles`, `password`, `avatar`, `username`, `is_verified`, `is_banned`, `google_id`, `uuid`, `poster`, `bio`, `twitter_id`) VALUES
	...
	(30, 'admin@admin.com', '["ROLE_ADMIN"]', '$2y$13$kCGYQs5RZe1fPY3BjwtPUuHHMd.llmJfzcc/wsFzH8rtTyuavZ9F.', '', 'admin', 1, 0, NULL, '0a784f6f-0694-11ee-af90-80e82c978fe5', '', 'vffdcvdcvgf', NULL),
